...
::: {layout-ncol=2}
![Estaciones Hidrográficas](inst2023-1.png){width=5in}


![Perfiladores Anclajes2](inst2023-2.png){width=5in}
...
![Revolución Lagrangiana](inst2023-3.png){width=5in}


![Percepción Remota](inst2023-4.png){width=5in}
